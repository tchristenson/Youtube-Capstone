...
def seed_videos():
    ...
    video15 = Video(
        ...
        description = "Immerse yourself in the captivating performance of a talented man as he mesmerizes the crowd at the renowned Sacre Coeur in Paris. Feel the magic in the air as his artistic expression takes center stage, leaving spectators in awe of his skills and presence. Join the enthusiastic audience as they revel in the delightful ambiance, surrounded by the timeless beauty of this iconic landmark.",
    ...
    video21 = Video(
        ...
        description = "Indulge in the sizzling artistry as a skilled chef takes command of a flat top grill, transforming ingredients into mouthwatering creations. Watch in awe as the flames dance beneath the sizzling surface, infusing tantalizing flavors into every dish.",
    ...
    video22 = Video(
        ...
        description = "Step into the world of pizza perfection as a skilled individual showcases their artistry by tossing the dough effortlessly into the air. Witness the seamless rhythm and precision as the dough gracefully spins and twirls, transforming into the foundation of a delicious pizza.",
    ...
    video25 = Video(
        ...
        description = "Prepare to be mesmerized as a dazzling fireworks display lights up the night sky, painting it with vibrant colors and patterns. Witness the explosive beauty as each firework bursts into a shower of shimmering lights, creating a symphony of awe-inspiring visual splendor.",
    ...
    video26 = Video(
        ...
        description = "Delight in the aromatic symphony as succulent pieces of meat are skewered and expertly grilled at a vibrant street food stand. Witness the sizzle and the tantalizing scents that fill the air, drawing you closer to this delectable display of culinary expertise.",
    ...
    video31 = Video(
        ...
        description = "Dive into the serene depths as an underwater camera captures the elegant movements of a man swimming. Witness the grace and fluidity as he glides through the water, surrounded by the tranquil blue hues. Feel the weightlessness and the soothing embrace of the underwater world as he explores this ethereal domain.",
    ...
    video34 = Video(
        ...
        description = "Indulge in a culinary masterpiece as a succulent chicken dish is meticulously plated at a renowned restaurant. Witness the chef's artistry unfold as every element is carefully arranged with precision and creativity. Admire the vibrant colors, enticing aromas, and the perfect harmony of flavors that grace the plate.",
    ...
    video39 = Video(
        ...
        description = "Immerse yourself in the enchanting allure of a rainforest waterfall, where nature's symphony plays out in harmonious beauty. Witness the cascading waters as they plunge into a crystal-clear pool, surrounded by lush greenery and vibrant flora. Feel the refreshing mist on your skin and the gentle roar of the waterfall that resonates through the dense foliage.",
    ...
    video40 = Video(
        ...
        description = "Experience the exhilarating rush of riding a motorcycle through winding forest trails in a thrilling first-person perspective. Immerse yourself in the immersive journey as you navigate the dense foliage, feeling the wind on your face and the rumble of the engine beneath you. Witness the beauty of nature up close as you weave through towering trees and conquer challenging terrain.",
    ...
    video43 = Video(
        ...
        description = "Witness the enchanting spectacle of a sunset on a serene beach, as the golden orb dips below the horizon, painting the sky with hues of orange, pink, and purple. Feel the gentle breeze caress your skin and the soft sand beneath your feet as you bask in the tranquil beauty of this idyllic moment.",
    ...
    video47 = Video(
        ...
        description = "Dive into an enchanting underwater world as you witness a captivating sight—an underneath view of two snorkelers exploring the mesmerizing depths of the ocean. Observe their graceful movements and the vibrant hues of their snorkeling gear against the backdrop of the azure waters. Feel the sense of wonder and serenity as you immerse yourself in this tranquil underwater realm, where marine life thrives and secrets unfold.",
